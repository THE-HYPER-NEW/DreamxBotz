...
PICS = (environ.get('PICS', 'https://files.catbox.moe/ag6195.jpg https://files.catbox.moe/gx1d4z.jpg https://files.catbox.moe/cwgvka.jpg https://files.catbox.moe/ffcudk.jpg')).split()  # Sample pic
...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/6yi47l.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7763229951').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002367446556').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002334193967'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002334193967'))  # Bin channel id (make sure bot is admin)
DREAMCINEZONE_MOVIE_UPDATE_CHANNEL = int(environ.get('DREAMCINEZONE_MOVIE_UPDATE_CHANNEL', '-1002476467166'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002334193967'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002467015295')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-100').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002504526170')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002358359240')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002348758566 -1002107236622 -1002131408527 -1002691486270 -1002467015295').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002348758566 -1002107236622 -1002131408527 -1002691486270 -1002467015295').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '9333474703@fam')
...
DREAMCINEZONE_VERIFIED_LOG = int(environ.get('DREAMCINEZONE_VERIFIED_LOG', '-1002476467166'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/howtoopen_modijiurls/6')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '7648cb86e7de30d93a3c109c39582b609879fa74')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtoopen_modijiurls/6')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MOVIE_SEARCHING_GROUP_ACX')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ACXBOTZ_UPDATE')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/THEHYPER_ACX')
DREAMCINEZONE_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DREAMCINEZONE_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/ACX_MOVIE_UPDATE')
OWNERID = int(os.environ.get('OWNERID', '7763229951'))  # Replace with the actual admin ID

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7763229951').split()]
